<div class="modal fade" id="addFamMem" tabindex="-1" aria-labelledby="addFamMemLabel" aria-hidden="true">
      ...
      <section class="px-2">
        ...
        <div class="row mb-1">
          <div class="col py-2">
              ...
              <textarea
              class="form-control" id="comment" name="comment" rows="5" placeholder="Any Comment"></textarea>
          </div>
        </div>
      </section>
      </div>
