                  ...
                  <div class="accordion-item">
                    ...
                    <div id="flushCollapse<?php echo $fam_mem['id_members']; ?>" class="accordion-collapse collapse" aria-labelledby="flushHeading<?php echo $fam_mem['id_members']; ?>" data-bs-parent="#accordionFlushExample">
                      <div class="accordion-body">
                        ...
                        <div class="row mb-1">
                          <div class="col py-2">
                            <button type="submit" class="btn btn-primary">Save changes</button> <a href="<?php echo base_url() . '/index.php/admin-delete-fam/'. $fam_mem['id_members']; ?>" class="btn btn-danger"> Delete <i class="bi bi-trash"></i></a>
                          </div>
                        </div>
                      </form>
                      </div>
