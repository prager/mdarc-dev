                        ...
                        <tr>
                         ...
                         <td><?php echo $user['email']; ?></td>
                           ...
                           <td class="text-center">
                             <?php
                             if($user['active'] == 1) { ?>
                               <a href="<?php echo base_url() . '/index.php/admin-deactivate/' . $user['id'];  ?>" class="text-decoration-none">Deactivate</a>
                             <?php
                             }
                             else { ?>
                               <a href="<?php echo base_url() . '/index.php/admin-activate/' . $user['id'];  ?>" class="text-decoration-none">Activate</a>
                             <?php
                             }
                             ?>
                           </td>
                          <td class="text-center">
                            ...
                            if($user['authorized'] == 1) { ?>
                              <a href="<?php echo base_url() . '/index.php/admin-unauthorize/' . $user['id'];  ?>" class="text-decoration-none">Unauthorize</a>
                            <?php
                            }
                            else { ?>
                              <a href="<?php echo base_url() . '/index.php/admin-authorize/' . $user['id'];  ?>" class="text-decoration-none">Authorize</a>
                            <?php
                            }
                            ?>
                          </td>
