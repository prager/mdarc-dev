...
;(function ( $, window, document, undefined ) {
    var upperCase = new RegExp('[A-Z][A-Z]');
    var lowerCase = new RegExp('[a-z][a-z]');
    var numbers = new RegExp('[0-9][0-9]');
    var specChars = new RegExp('[!@#$%\^&*)(+=._-][!@#$%\^&*)(+=._-]');
    ...
    Plugin.prototype._create = function () {
        ...
        this.element.append(
            ...
            <li data-criterion="capital" class="valid">At least <strong>two capital letters</strong></li> \
            <li data-criterion="number" class="valid">At least <strong>two numbers</strong></li> \
            <li data-criterion="lowcase" class="valid">At least <strong>two lowcase letters</strong></li> \
            <li data-criterion="character" class="valid">At least <strong>two special characters</strong></li> \
    ...
    Plugin.prototype._bind_input_events = function($s) {
        ...
        $s.bind('keyup', function () {
            ...
            var capitalletters = password.match(upperCase) ? 2 : 0;
            var loweletters = password.match(lowerCase) ? 2 : 0;
            var number = password.match(numbers) ? 2 : 0;
            var specChar = password.match(specChars) ? 2 : 0;
            var containWhiteSpace = password.indexOf(' ') >= 0 ? 1 : 0;

            var total = characters + capitalletters + loweletters + number + specChar;
            ...
            that._update_info('lowcase', loweletters);
            that._update_info('character', specChar);
